...
module.exports = (client, receivedMessage) => {
    ...
    */
    if(receivedMessage.guild !== null && receivedMessage.guild !== undefined) {
        ...
        if(spaceless.match(/^h{1,}$/gi)) {
            ...
            if(spaceless.length > 9) {
                receivedMessage.react(":calpression:609496157122723840")
            }
        }
        ...
        if(message.match(/egg/gi) || (message == 'eg')) {receivedMessage.react("🥚")}
    ...
    if(receivedMessage.content.includes("stone head") || receivedMessage.content.includes("rock head") || receivedMessage.content.includes("gay ass") || receivedMessage.content.includes("rock ass") || receivedMessage.content.includes("looking ass")) {
        receivedMessage.react(":pensive_moyai:608795229134258178")
    }
    if(receivedMessage.content.match(/bo(o+)ped/)  || receivedMessage.content.match(/bo(o+)ping/) || receivedMessage.content.match(/\*bo(o+)ps/) || receivedMessage.content.toLowerCase().includes('uwu')) {
        receivedMessage.react(":uwu:562330233446072321")
    }
